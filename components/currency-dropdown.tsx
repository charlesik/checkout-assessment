...
const cryptoOptions = [
  { id: "usdt-celo", name: "NGN", icon: "N" },
  { id: "usdt-ton", name: "USD", icon: "$" },
  { id: "usdt-bnb", name: "GBP", icon: "E" },
...
export function CurrencyDropdown({ selected, onSelect }: CryptoDropdownProps) {
